import 'package:coo_sport/common/widgets/list_tiles/user_profile_tile.dart';
            ...
            TPrimaryHeaderContainer(
              child: Column(
                children: [
                  ...
                  /// User Profile Card
                  TUserProfileTile(user: TDummyData.user, onPressed: () => Get.to(() => const ProfileScreen())),
              ...
              child: Column(
                ...
                children: [
                  ...
                  TSettingsMenuTile(
                    ...
                    onTap: () => Get.to(() => const CartScreen(title: '',)),
                  ),
                  TSettingsMenuTile(
