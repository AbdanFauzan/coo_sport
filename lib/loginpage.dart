            ...
            onPressed: (){
              showModalBottomSheet(context: context, builder: (context) => Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text(tForgetPasswordTitle, style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
                    const Text(tForgetPasswordSubTile, style: TextStyle(fontWeight: FontWeight.normal)),
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text("Reset via Email", style: TextStyle(fontWeight: FontWeight.normal)),
                              ],
                            )
                          ],
                        ),
